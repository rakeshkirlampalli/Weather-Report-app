            ...
            <div className="container-fluid">
                ...
                <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <p className='text-center mt-2' style={{fontFamily:"Tahoma"}}>
                           ...
                           <li className="nav-item">
                                <a className="nav-link active mt-1 mb-1 fw-medium" aria-current="page" style={{cursor:"pointer"}} onClick={()=>{navigate('/home');}}>city Forecast</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link active mt-1 mb-1 fw-medium" aria-current="page" style={{cursor:"pointer"}} onClick={()=>{navigate('/temperature');}}>Temperature Forecast</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link active mt-1 mb-1 fw-medium" aria-current="page" style={{cursor:"pointer"}} onClick={()=>{navigate('/hourly');}}>Hourly Forecast</a>
                            </li>
                           
                            {adminEmail==user?.user?.email&&<li className="nav-item">
                                <a className="nav-link mt-1 mb-1 fw-medium" style={{cursor:"pointer"}} onClick={()=>{navigate('/users');}}>UsersManagement</a>
                            </li>}
